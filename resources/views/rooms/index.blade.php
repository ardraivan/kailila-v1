                ...
                <div class="col-md-6">
                    <div class="card mt-5 shadow">
                        <div class="card-body text-center">
                            ...
                            <p class="lead">Seems like there are no therapy rooms created yet.</p>
                            <p class="text-justify mb-4">
                                Please create a new therapy room by
                                <strong>clicking the "Create Storage" button</strong>,
                                then fill in the necessary details in the form and choose
                                <strong>"Therapy Room" as the storage type</strong>.
                                Finally, <strong>submit the form</strong> to
                                create the therapy room.
                            </p>
                ...
                @foreach ($therapyRooms as $room)
                    <div class="col-lg-4 col-md-6 col-sm-12">
                        ...
                        <div class="card"
                            ...
                            <div class="card-footer bg-secondary text-right py-2" style="border-radius: 0px 0px 10px 10px;">
